...
public class Qa_Assignment {
	 public static void main(String[] args) throws InterruptedException, AWTException {
		    ...
		    driver.findElement(By.xpath("//li[text()='Generator']")).click();
			    ...
			    // -----------GENERATOR INFO -------------------
			driver.findElement(By.xpath("//input[@placeholder='Enter generator name']")).sendKeys("Rocky5");
			driver.findElement(By.xpath("//input[@placeholder='Enter internal account number']")).sendKeys("123459564712");
		    ...
		    driver.findElement(By.xpath("//input[@id='serviceAddress-street']")).sendKeys("Mahisbathan, Sector V, SaltLake, 700091");
		    ...
		    driver.findElement(By.xpath("//input[@placeholder='Email Address']")).sendKeys("Rocky2345@gmail.com");
		    driver.findElement(By.xpath("//input[@placeholder='(123) 456-7890']")).sendKeys("367243");
		    Thread.sleep(2000);
		    System.out.println("Giving the billing information successfully");
		    ...
		    System.out.println("Generate the latitude and longitude successfully");
			...
			System.out.println("Copy the billing information successfully");
			Thread.sleep(2000);
			...
			//--------------- COPY ALL THE HOURS FOR ALL DAYS ----------------- 
		    ...
		    System.out.println("Copy and paste the service hours successfully");
